    ...
    <div className="max-w-6xl mx-auto mt-6 grid gap-5">
      ...
      <Section title="How to use">
        <ul className="list-disc pl-6 text-sm text-gray-700 space-y-1">
          <li>Use <b>Orders</b> to create orders. Same customer + same date is <b>auto-consolidated</b>.</li>
...
const Tabs = { DASHBOARD: "Dashboard", ORDERS: "Orders", PRODUCTS: "Products", CUSTOMERS: "Customers", INVOICES: "Invoices" };
